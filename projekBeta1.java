...
public class projekBeta1 {
    ...
    public static void main(String[] args) {
        ...
        int menuAdmin, jumlahPegawai = 0,menuManajer, menuManajemen, jumlahPermintaan = 0;
        boolean isAuthenticated = false;
        boolean pesan = true;
        boolean ifManajer = true;
        double totalPengeluaranGaji = 0;
        int pegawaiBerkinerjaBaik = 0, pegawaiCukupBerkinerja = 0, pegawaiPerluPerbaikan = 0, totalKehadiran = 0, totalTidakHadir = 0;
        Scanner input = new Scanner(System.in);

        // mendeklarasikan array
        //String[] namaPegawai2, jenisKelaminPegawai, ttlPegawai, kebangsaanPegawai, emailPegawai, alamatPegawai,teleponPegawai;
            ...
            for (int kesempatanLogin = 1; kesempatanLogin <= 3; kesempatanLogin++) { // Membatasi jumlah maksimal
                ...
                if (isAuthenticated) {
                    ...
                    if (usernameInput.equalsIgnoreCase("pegawai2")) {
                        ...
                        System.out.println("Karyawan dengan Jam Kerja Terbanyak: " + namaPegawai3[indexKaryawanMaxJam]);
                        break;
            ...
            switch (pilihanMenuCuti) {
                ...
                case 3:
                    ...
                    if (nomorPermintaan >= 0 && nomorPermintaan < jumlahPermintaan) {
                        ...
                        System.out.println("Permintaan cuti disetujui untuk karyawan " + namaPegawai2[nomorPermintaan]);
                    } else {
